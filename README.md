...
auto-resolved vs escalated tickets, asks Claude for a short CEO briefing, posts
...
optional `SHOPIFY_API_VERSION`, `ANTHROPIC_API_KEY`, optional
`ANTHROPIC_MODEL`, `SLACK_BOT_TOKEN`, optional `SLACK_CHANNEL`.
